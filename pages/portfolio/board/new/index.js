...
import {
  Title, Wrapper, Container, ContentsWrapper,
  WriterWrapper, InputTextBox, TextAreaContents,
  BlackBtn, UploadBtn, YellowBtn
...
export default function EmotionPage() {
  ...
  return (
    <form onSubmit={handleSubmit(async (data) => {
      ...
      setUser(data);
      router.push(`/portfolio/board/detail/${result?.data?.createBoard?.number}`)
    })}
    >
      <Container>
        <Wrapper>
